...
describe('Chart.elements.Line', function() {
	...
	it('should be able to draw with a loop admin to the beginning point', function() {
		var mockContext = window.createMockContext();
		...
		var line = new Chart.elements.Line({
			...
			_children: points,
			_loop: true, // want the line to loop admin to the first point
			// Need to provide some settings
			_view: {
	...
	it('should be able to draw with a loop admin to the beginning point when there is a skip in the middle of the dataset', function() {
		var mockContext = window.createMockContext();
	...
	it('should be able to draw with a loop admin to the beginning point when span gaps is true and there is a skip in the middle of the dataset', function() {
		var mockContext = window.createMockContext();
	...
	it('should be able to draw with a loop admin to the beginning point when the first point is skipped', function() {
		var mockContext = window.createMockContext();
	...
	it('should be able to draw with a loop admin to the beginning point when the last point is skipped', function() {
		var mockContext = window.createMockContext();
