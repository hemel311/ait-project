            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center">Admission Contact info</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{route('add-admission-contact')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="submit" class="btn btn-outline-success" value="Add admission contact">
                                </div>
                            </div>
                        </form>
                    </div>
