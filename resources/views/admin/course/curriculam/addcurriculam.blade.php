                ...
                <div class="col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center">Add Curriculam</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('create-new-curriculam')}}" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label for="" class="form-label col-md-3">Course Category</label>
                                    <div class="col-md-8">
                                        <select name="category_id" id="" class="form-control">
                                            <option value="" selected>Select a course Category</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" class="btn btn-success" value="Add Curriculam">
                                    </div>
                                </div>
                            </form>
                        </div>
