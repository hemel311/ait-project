            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                    <div class="footer-logo mb-30">
                        <a href="{{route('home')}}"><img src="{{asset('/front/assets')}}/images/ait.png" alt=""></a>
                    </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 footer-widget">
                    ...
                    <div class="recent-post mb-20">
                        <div class="post-img">
                            <img src="{{asset('/front/assets')}}/images/footer/1.jpg" alt="">
                        </div>
                        <div class="post-item">
                            <div class="post-desc">
                    ...
                    <div class="recent-post mb-20 md-pb-0">
                        <div class="post-img">
                            <img src="{{asset('/front/assets')}}/images/footer/2.jpg" alt="">
                        </div>
                        <div class="post-item">
                            <div class="post-desc">
