    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-mb-40">
                <div class="img-part">
                    <img src="{{asset('/front/assets')}}/images/download/m-app.png" alt="">
            ...
            <div class="col-lg-6 pl-60 md-pl-15">
                ...
                <div class="mobile-img">
                    <div class="apps-image pr-20 sm-pr-5">
                        <img src="{{asset('/front/assets')}}/images/download/play.png" alt="">
                    </div>
                    <div class="apps-image">
                        <img src="{{asset('/front/assets')}}/images/download/apple.png" alt="">
                    </div>
                </div>
            </div>
        </div>
